...
export const EMAIL_TEMPLATES = {
    VERIFY_EMAIL: (name, token) => `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="${ENVIRONMENT.URL_BACKEND}/api/auth/verify-email?verify_email_token=${token}" 
    ...
    RESET_PASSWORD: (name, token) => `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="${ENVIRONMENT.URL_BACKEND}/api/auth/reset-password/${token}" 
                   style="background-color: #655dd4; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
